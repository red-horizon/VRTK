...
namespace VRTK
{
    ...
    public class VRTK_PlayerClimb : MonoBehaviour
    {
        ...
        public Vector3 safePos = new Vector3();
        protected virtual void Update()
        {
            if (isClimbing)
            {
                ...
                if (!IsColliding())
                {
                    safePos = playArea.position;
                    //positionRewind.SetLastSafePosition();
                }
            }
        }
...
#pragma warning restore 0618
        ...
        protected virtual void Ungrab(bool carryMomentum, VRTK_ControllerReference controllerReference, GameObject target)
        {
            ...
            if (IsColliding())
            {
                playArea.position = safePos;
                //positionRewind.RewindPosition(true, true);
            }
